...
def main():
    testResults = []
    fileScript_8455 = open("C://Users//Me//Downloads//allAcounts_ORT_8455.txt",'a')
    fileScript_845 = open("C://Users//Me//Downloads//allAcounts_ORT_845.txt", 'a')
    fileScript_remaining = open("C://Users//Me//Downloads//allAcounts_ORT_remaining.txt", 'a')
    envs = ['proda']
    ...
    for env in envs:
        ...
        for eachAccount in accountsInFeatureGroup:
            print(eachAccount)
            if eachAccount.contains("8455") == True:
                fileScript_8455.write(eachAccount + "\n")
            elif eachAccount.contains("845") == True:
                fileScript_845.write(eachAccount + "\n")
            else:
                fileScript_remaining.write(eachAccount)
